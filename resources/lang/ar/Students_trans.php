...
return [
    ...
    'delete' => 'تراجع الكل',
    'delete' => 'المرحلة الدراسية السابقة',
    'delete' => 'السنة الدراسية',
    'delete' => 'الصف الدراسي السابق',
    'delete' => 'القسم الدراسي السابق',
    'delete' => 'المرحلة الدراسية الحالي',
    'delete' => 'السنة الدراسية الحالية',
    'delete' => 'الصف الدراسي الحالي',
    'delete' => 'القسم الدراسي الحالي',
    'delete' => 'حذف',
    'delete' => 'حذف',
    'delete' => 'حذف',
    'delete' => 'حذف',
