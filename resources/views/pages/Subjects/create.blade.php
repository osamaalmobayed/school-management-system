                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('subjects.store')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">{{trans('subjects.subject_name_ar')}}<label for="title"> </label>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('subjects.save_data')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
