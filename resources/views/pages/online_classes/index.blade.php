            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('online_classes.create')}}" class="btn btn-success" role="button" aria-pressed="true">Add an online Zoom Classroom
</a>
                                <a class="btn btn-warning" href="{{route('indirect.create.admin')}}">Add an offline Zoom Classroom</a>
