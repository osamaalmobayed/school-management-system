            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('online_zoom_classes.create')}}" class="btn btn-success" role="button" aria-pressed="true">Add a new Zoom meeting</a>
                                <a class="btn btn-warning" href="{{route('indirect.teacher.create')}}">Add a new Zoom meeting manually</a>
