                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-danger">previous Grade</th>
                                            <th class="alert-danger">previous Academic year</th>
                                            <th class="alert-danger">previous class</th>
                                            <th class="alert-danger">previous section</th>
                                            <th class="alert-success">current Grade</th>
                                            <th class="alert-success">current Academic year</th>
                                            <th class="alert-success">current classroom</th>
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#">Graduate Student </button>
                                                </td>
                                            </tr>
