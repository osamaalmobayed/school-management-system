                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Quizzes.store')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">Quizze name in Arabic</label>
                                        <input type="text" name="Name_ar" class="form-control">
                                    </div>

                                    <div class="col">
                                        <label for="title">Quizze name in English</label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">Teacher's name   : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="teacher_id">
                                                <option selected disabled>Select the teacher's name...</option>
