    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{route('ProcessingFee.index')}}">{{trans('main_trans.fee_excluded')}}</a> </li>
                <li> <a href="{{route('Payment_students.index')}}">{{trans('main_trans.exchange_bills')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Attendance.index')}}"> {{trans('main_trans.attendance_list')}} </a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">{{trans('main_trans.booklist')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('online_classes.index')}}">{{trans('main_trans.zoom_classroom')}}</a> </li>
            </ul>
        </li>
